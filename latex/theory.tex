This chapter aims to provide a more formal description of our turn taking model. First we present a formal definition of a conversation, turn changes and local features. Next we presents the formulas to compute the summary features: relative turn length and relative floor control.
